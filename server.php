...
$database_connection = mysqli_connect('localhost', 'root', '', 'RealEstate');
...
if (isset($_POST['reg_user'])) {
  ...
  $password_1 = mysqli_real_escape_string($database_connection, $_POST['password_1']);
  $password_2 = mysqli_real_escape_string($database_connection, $_POST['password_2']);
